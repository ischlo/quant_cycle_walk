...
# if running this script independently of the reproducibility workflow, uncomment to add the support functions.
...
if(file.exists('benchmarks/cppr_networks/osm_cycle.rds')) {
  ...
  # save result
  osm_cycle |> rlist::list.save('benchmarks/cppr_networks/osm_cycle.rds')
}
